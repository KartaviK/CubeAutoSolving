...
namespace RubiksAutoSolve
{
    public static class SimpleRotate
    {
        ...
        public static void Mi(ref Cube cube)
        {
            ...
            cache = cube.edge[5][1, 0];
            cube.edge[5][1, 0] = cube.edge[4][1, 0];
            cube.edge[4][1, 0] = cube.edge[0][1, 0];
            cube.edge[0][1, 0] = cube.edge[2][1, 2];
            cube.edge[2][1, 2] = cache;
        }
        ...
        public static bool CheckFirstPhase(ref Cube cube)
        {
            return (cube.edge[5][1, 0] == cube.edge[5][1, 1] 
                && cube.edge[5][0, 1] == cube.edge[5][1, 1] 
                && cube.edge[5][2, 1] == cube.edge[5][1, 1] 
                && cube.edge[5][1, 2] == cube.edge[5][1, 1]);
            /*return (cube.edge[0][0, 0] == cube.edge[0][1, 1] || cube.edge[0][0, 0] == cube.edge[5][1, 1])
                ...
                && (cube.edge[0][2, 2] == cube.edge[0][1, 1] || cube.edge[0][2, 2] == cube.edge[5][1, 1]) // Верхняя сторона
                ...
                && (cube.edge[5][2, 2] == cube.edge[0][1, 1] || cube.edge[5][2, 2] == cube.edge[5][1, 1]) // Нижняя сторона
                && (cube.edge[2][1, 0] == cube.edge[2][1, 1] || cube.edge[2][1, 0] == cube.edge[4][1, 1])
                && (cube.edge[2][1, 2] == cube.edge[2][1, 1] || cube.edge[5][1, 2] == cube.edge[4][1, 1]) // фронтальные ребра
                && (cube.edge[4][1, 0] == cube.edge[2][1, 1] || cube.edge[4][1, 0] == cube.edge[4][1, 1])
                && (cube.edge[4][1, 2] == cube.edge[2][1, 1] || cube.edge[4][1, 2] == cube.edge[4][1, 1]);  // Задние ребра*/
        }
